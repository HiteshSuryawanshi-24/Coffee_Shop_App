...
public class Update_Delete_Item_Acivity extends AppCompatActivity {
    ...
    public void getItemData() {
        ...
        pd.setTitle("Searching Item to Server...");
        pd.setMessage("Please wait... Searching Item  to Server...");
        pd.show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        data = null;
//                        Toast.makeText(Update_Delete_Item_Acivity.this, "SrNo="+SrNo, Toast.LENGTH_SHORT).show();
//                        Toast.makeText(Update_Delete_Item_Acivity.this, "Name="+Name, Toast.LENGTH_SHORT).show();
    ...
    public void operation() {
        ...
        if (option.equalsIgnoreCase("Update")) {
            Intent i = new Intent(Update_Delete_Item_Acivity.this, Update_item_Activity.class);
            i.putExtra("SrNo", SelectedSrNo);
            i.putExtra("Name", Name.get(SelItemSrNo));
            i.putExtra("Price", Price.get(SelItemSrNo));
            i.putExtra("Desc", Desc.get(SelItemSrNo));
            i.putExtra("ImgPath", ImgPath.get(SelItemSrNo));
            startActivity(i);
